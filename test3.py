...
#     rf_model = joblib.load('svm_face_train_modelnew.pkl')
...
#                 predicted_class_index = rf_model.predict(feat.reshape(1, -1))[0]
#                 recognized_name = df_target.loc[int(predicted_class_index), "name"]
